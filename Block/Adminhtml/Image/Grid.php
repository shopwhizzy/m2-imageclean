...
namespace MgtWizards\ImageClean\Block\Adminhtml\Image;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    /**
     * @var \MgtWizards\ImageClean\Model\imageFactory
     */
     ...
     * @param \MgtWizards\ImageClean\Model\imageFactory       $imageFactory
    ...
    public function __construct(
        ...
        \MgtWizards\ImageClean\Model\ImageFactory $ImageFactory,
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            array(
                'header' => __('Image'),
                'index' => 'value',
                'renderer' => '\MgtWizards\ImageClean\Block\Adminhtml\Image\Grid\Renderer\Image',
            )
        );
        ...
        $this->addColumn('action', array(
            ...
            'renderer' => 'MgtWizards\ImageClean\Block\Adminhtml\Image\Grid\Renderer\Action',
            'index' => 'value_id',
        ));
    ...
    /**
     * @param \MgtWizards\ImageClean\Model\image|\Magento\Framework\Object $row
     *
     * @return string
     */
